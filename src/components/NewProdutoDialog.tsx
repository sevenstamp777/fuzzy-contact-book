...
import { Insumo, ProdutoBase } from "@/pages/Produtos";
    ...
    <>
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Combine produto base + insumos + tempo de produção para calcular o preço.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
